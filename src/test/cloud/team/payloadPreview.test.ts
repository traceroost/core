...
import { buildPayloadForCard, createPayloadBuildCache } from '../../../cloud/team/payloadPreview'
...
function memoryStore(initial: TeamCredentials | null): CredentialStore {
  let cur = initial
...
suite('team/payloadPreview — createPayloadBuildCache', () => {
  let repoA: string
  let repoB: string
